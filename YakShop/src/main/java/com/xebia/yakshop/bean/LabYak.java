package com.xebia.yakshop.bean;

import com.xebia.yakshop.constants.YakConstants;
import com.xebia.yakshop.exceptions.YakException;
...
public class LabYak {
    ...
    public String display(int elapsedTimeInDays) {
        return isAlive(elapsedTimeInDays) ? name + " " + (age*100+elapsedTimeInDays)/100 + " years old" : YakConstants.YAK_DIED_MSG;
    }
    ...
    private boolean canShaveToday(int currentAgeInDays)throws YakException{
        ...
        if(isAlive(currentAgeInDays)) {
            ...
            throw new YakException(YakConstants.YAK_DIED_MSG);
